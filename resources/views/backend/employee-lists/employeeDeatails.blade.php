                        ...
                        <form action="{{ route('employee.update',$user->id) }}" method="Post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="Name" placeholder="First Name" value="{{ $user->first_name }}" name="first_name">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="Name">Full Name</label>
                                    <input type="text" class="form-control" id="Name" placeholder="Full Name" value="{{ $user->full_name }}" name="full_name">
                                </div>
                                <div class="col-md-12 mb-3">
